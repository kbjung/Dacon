...
+ data2, 8특성 제거, random_state 5가지, pb_thr(2021.01.13)
  - ver4.7 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-02_pycaret_ver4.7.html)
+ data2, 5특성 제거, random_state 5가지, pb_thr(2021.01.14)
  - ver4.8 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-02_pycaret_ver4.8.html)
+ data2, 7특성 제거, random_state 10가지, pb_thr(2021.01.14)
  - ver4.9 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-02_pycaret_ver4.9.html)
+ data2, 7특성 제거, random_state 10가지, pb_thr(2021.01.18)
  - ver5.0 : cat/ohe=2이하, early=100/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-02_pycaret_ver5.0.html)
+ data2, 7특성 제거, random_state 5가지, pb_thr(2021.01.18)
  - ver5.1 : cat/ohe=2이하, early=100/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-02_pycaret_ver5.1.html)
+ data1, 7특성 제거, random_state 5가지, pb_thr(2021.01.18)
  - ver5.2 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-02_pycaret_ver5.2.html)
...
+ data2, 7특성 제거, random_state 5가지(높은 점수 결과만), pb_thr(2021.01.20)
  ...
  - 자체 점수 ↑, 제출 점수 ↓ ⇒ 과대적합
+ data2, 7특성 제거, random_state 5가지(높은 점수 결과만), pb_thr(2021.01.20)
  - ver5.7 : cat/ohe=2이하, early=77, test_size=0.2/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-02_pycaret_ver5.7.html)
