...
+ data2, 4특성 제거, pb_thr(2021.01.07)
  - ver4.1 : cat/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver4.1.html)
+ data2, 4특성 제거, pb_thr(2021.01.11)
  - ver4.2 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver4.2.html)
+ data2, 7특성 제거, pb_thr(2021.01.12)
  - ver4.3 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver4.3.html)
+ data2, 9특성 제거, pb_thr(2021.01.12)
  - ver4.4 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver4.4.html)
+ data2, 9특성 제거, random_state 5가지, pb_thr(2021.01.12)
  - ver4.5 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver4.5.html)
+ data2, 7특성 제거, random_state 5가지, pb_thr(2021.01.13)
  - ✨ver4.6 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver4.6.html)
+ data2, 4특성 제거, random_state 5가지, pb_thr(2021.01.13)
  - ver4.6.1 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver4.6.1.html)
+ data2, 6특성 제거, random_state 5가지, pb_thr(2021.01.13)
  - ver4.6.2 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver4.6.2.html)
+ data2, 8특성 제거, random_state 5가지, pb_thr(2021.01.13)
  - ver4.7 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver4.7.html)
+ data2, 5특성 제거, random_state 5가지, pb_thr(2021.01.14)
  - ver4.8 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver4.8.html)
+ data2, 7특성 제거, random_state 10가지, pb_thr(2021.01.14)
  - ver4.9 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver4.9.html)
+ data2, 7특성 제거, random_state 10가지, pb_thr(2021.01.18)
  - ver5.0 : cat/ohe=2이하, early=100/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver5.0.html)
+ data2, 7특성 제거, random_state 5가지, pb_thr(2021.01.18)
  - ver5.1 : cat/ohe=2이하, early=100/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver5.1.html)
+ data1, 7특성 제거, random_state 5가지, pb_thr(2021.01.18)
  - ver5.2 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver5.2.html)
+ pycaret, data1, 8특성 제거, pb_thr(2021.01.19)
  - ver5.3 : blend(cat, tuned_lgbm)/comb,nu/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-02_pycaret_ver5.3.html)
+ data2, 7특성 제거, random_state 5가지(높은 점수 결과만), pb_thr(2021.01.19)
  - ver5.4 : cat/ohe=2이하, early=50/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver5.4.html)
+ data2, 7특성 제거, random_state 10가지(높은 점수 결과만), pb_thr(2021.01.19)
  - ver5.5 : cat/ohe=2이하, early=100/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver5.5.html)
+ 여러 test_size 적용, data2, 7특성 제거, random_state 5가지(높은 점수 결과만), pb_thr(2021.01.20)
  - ver5.6.1 : cat/ohe=2이하, early=77/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver5.6.1.html)
+ data2, 7특성 제거, random_state 5가지(높은 점수 결과만), pb_thr(2021.01.20)
  - ver5.6 : cat/ohe=2이하, early=77, test_size=0.1/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver5.6.html)
  - 자체 점수 ↑, 제출 점수 ↓ ⇒ 과대적합
+ data2, 7특성 제거, random_state 5가지(높은 점수 결과만), pb_thr(2021.01.20)
  - ver5.7 : cat/ohe=2이하, early=77, test_size=0.2/pb_thr [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver5.7.html)
...
+ cat/data2, 12특성제거, minmax, rd:5/ohe=2이하,early=50/pb_thr(2021.01.22)
  - ver6.2 [code(html)](https://kbjung.github.io/Dacon/TP2(잡케어)/03_모델선정및개선/03-04_catboost_ver6.2.html)
